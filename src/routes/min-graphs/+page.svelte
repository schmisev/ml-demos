...
<div class="flex h-dvh flex-col gap-2 p-2 min-h-0">
	...
	<div class="grid min-h-0 grow grid-cols-2 gap-2">
      ...
      <h2>Markup</h2>
			<div class="{!error ? 'text-black' : 'text-red-500'} font-bold">
				{error || 'No error found!'}
			</div>
			<textarea class="h-30 w-full rounded font-mono text-sm" bind:value={src}></textarea>
			<div class="text-xs">
				<b>*</b>initial node,
				<b>+</b>teminal node,
				<b>[0-9]+</b> for nodes,

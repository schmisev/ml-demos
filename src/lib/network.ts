...
export function network_to_graph(network: NetworkData): GraphNode[] {
  ...
  for (const [k, v] of get_entries(network.nodes)) {
    nodes[k] = { node: v, links: [] };
  }
	...
	return get_values(nodes);
}

export const NETWORK_ROMANIA: NetworkData = {
	physics: {...STANDARD_PHYSICS, zoom: 0.4},
	nodes: {
		"0": { id: 0, name: 'Arad', meta: { coord: { lat: 46.1667, lon: 21.3167 } } },
		"1": { id: 1, name: 'Zerind', meta: { coord: { lat: 46.6167, lon: 21.5167 } } },
		"2": { id: 2, name: 'Oradea', meta: { coord: { lat: 47.0722, lon: 21.9211 } } },
		"3": { id: 3, name: 'Sibiu', meta: { coord: { lat: 45.7928, lon: 24.1522 } } },
		"4": { id: 4, name: 'Timișoara', meta: { coord: { lat: 45.7489, lon: 21.2087 } } },
		"5": { id: 5, name: 'Lugoj', meta: { coord: { lat: 45.6886, lon: 21.9031 } } },
		"6": { id: 6, name: 'Mehadia', meta: { coord: { lat: 44.9, lon: 22.3667 } } },
		"7": { id: 7, name: 'Turnu Severin', meta: { coord: { lat: 44.6369, lon: 22.6597 } } },
		"8": { id: 8, name: 'Craiova', meta: { coord: { lat: 44.3167, lon: 23.8 } } },
		"9": { id: 9, name: 'Râmnicu Vâlcea', meta: { coord: { lat: 45.1, lon: 24.3667 } } },
		"10": { id: 10, name: 'Pitești', meta: { coord: { lat: 44.8565, lon: 24.8692 } } },
		"11": { id: 11, name: 'București', meta: { coord: { lat: 44.4325, lon: 26.1039 } } },
		"12": { id: 12, name: 'Făgăraș', meta: { coord: { lat: 45.8411, lon: 24.9739 } } },
		"13": { id: 13, name: 'Giurgiu', meta: { coord: { lat: 43.9, lon: 25.9667 } } },
		"14": { id: 14, name: 'Urziceni', meta: { coord: { lat: 44.7167, lon: 26.6333 } } },
		"15": { id: 15, name: 'Hârșova', meta: { coord: { lat: 44.6833, lon: 27.9333 } } },
		"16": { id: 16, name: 'Eforie', meta: { coord: { lat: 44.0667, lon: 28.6333 } } },
		"17": { id: 17, name: 'Vaslui', meta: { coord: { lat: 46.6333, lon: 27.7333 } } },
		"18": { id: 18, name: 'Iași', meta: { coord: { lat: 47.1622, lon: 27.5889 } } },
		"19": { id: 19, name: 'Neamț', meta: { coord: { lat: 46.9333, lon: 26.3667 } } }
  },
	links: [
...
export const NETWORK_GERMANY: NetworkData = {
	...
	nodes: {
		"0": { id: 0, name: 'Berlin', meta: { coord: { lat: 52.5200, lon: 13.4050 } } },
		"1": { id: 1, name: 'Hamburg', meta: { coord: { lat: 53.5511, lon: 9.9937 } } },
		"2": { id: 2, name: 'Munich', meta: { coord: { lat: 48.1351, lon: 11.5820 } } },
		"3": { id: 3, name: 'Cologne', meta: { coord: { lat: 50.9375, lon: 6.9603 } } },
		"4": { id: 4, name: 'Frankfurt am Main', meta: { coord: { lat: 50.1109, lon: 8.6821 } } },
		"5": { id: 5, name: 'Stuttgart', meta: { coord: { lat: 48.7758, lon: 9.1829 } } },
		"6": { id: 6, name: 'Düsseldorf', meta: { coord: { lat: 51.2277, lon: 6.7735 } } },
		"7": { id: 7, name: 'Dortmund', meta: { coord: { lat: 51.5136, lon: 7.4653 } } },
		"8": { id: 8, name: 'Leipzig', meta: { coord: { lat: 51.3397, lon: 12.3731 } } },
		"9": { id: 9, name: 'Bremen', meta: { coord: { lat: 53.0793, lon: 8.8017 } } },
		"10": { id: 10, name: 'Dresden', meta: { coord: { lat: 51.0504, lon: 13.7373 } } },
		"11": { id: 11, name: 'Hanover', meta: { coord: { lat: 52.3759, lon: 9.7320 } } },
		"12": { id: 12, name: 'Nuremberg', meta: { coord: { lat: 49.4521, lon: 11.0767 } } },
		"13": { id: 13, name: 'Essen', meta: { coord: { lat: 51.4556, lon: 7.0116 } } },
		"14": { id: 14, name: 'Bonn', meta: { coord: { lat: 50.7374, lon: 7.0982 } } },
		"15": { id: 15, name: 'Mannheim', meta: { coord: { lat: 49.4875, lon: 8.4660 } } },
		"16": { id: 16, name: 'Karlsruhe', meta: { coord: { lat: 49.0069, lon: 8.4037 } } },
		"17": { id: 17, name: 'Freiburg', meta: { coord: { lat: 47.9990, lon: 7.8421 } } },
		"18": { id: 18, name: 'Kiel', meta: { coord: { lat: 54.3233, lon: 10.1228 } } },
		"19": { id: 19, name: 'Rostock', meta: { coord: { lat: 54.0924, lon: 12.0991 } } },
		"20": { id: 20, name: 'Magdeburg', meta: { coord: { lat: 52.1205, lon: 11.6276 } } },
		"21": { id: 21, name: 'Erfurt', meta: { coord: { lat: 50.9848, lon: 11.0299 } } },
		"22": { id: 22, name: 'Wiesbaden', meta: { coord: { lat: 50.0826, lon: 8.2493 } } },
		"23": { id: 23, name: 'Lübeck', meta: { coord: { lat: 53.8655, lon: 10.6866 } } },
		"24": { id: 24, name: 'Chemnitz', meta: { coord: { lat: 50.8278, lon: 12.9214 } } }
  },
	links: [
...
export const NETWORK_MUNICH: NetworkData = {
	...
	nodes: {
		"0": { id: 0, name: 'Munich Center', meta: { coord: { lat: 48.1372, lon: 11.5756 } } },
		"1": { id: 1, name: 'Maxvorstadt', meta: { coord: { lat: 48.1500, lon: 11.5670 } } },
		"2": { id: 2, name: 'Schwabing', meta: { coord: { lat: 48.1630, lon: 11.5810 } } },
		"3": { id: 3, name: 'Garching Forschungszentrum', meta: { coord: { lat: 48.2670, lon: 11.6740 } } },
		"4": { id: 4, name: 'Garching', meta: { coord: { lat: 48.2500, lon: 11.6500 } } },
		"5": { id: 5, name: 'Freimann', meta: { coord: { lat: 48.2000, lon: 11.6200 } } },
		"6": { id: 6, name: 'Milbertshofen', meta: { coord: { lat: 48.1850, lon: 11.5720 } } },
		"7": { id: 7, name: 'Olympiapark', meta: { coord: { lat: 48.1745, lon: 11.5510 } } },
		"8": { id: 8, name: 'Sendling', meta: { coord: { lat: 48.1170, lon: 11.5400 } } },
		"9": { id: 9, name: 'Thalkirchen', meta: { coord: { lat: 48.0990, lon: 11.5540 } } },
		"10": { id: 10, name: 'Haidhausen', meta: { coord: { lat: 48.1310, lon: 11.6000 } } },
		"11": { id: 11, name: 'Bogenhausen', meta: { coord: { lat: 48.1520, lon: 11.6170 } } },
		"12": { id: 12, name: 'Trudering', meta: { coord: { lat: 48.1250, lon: 11.6500 } } },
		"13": { id: 13, name: 'Riem', meta: { coord: { lat: 48.1350, lon: 11.6900 } } },
		"14": { id: 14, name: 'Neuperlach', meta: { coord: { lat: 48.0900, lon: 11.6500 } } },
		"15": { id: 15, name: 'Perlach', meta: { coord: { lat: 48.0850, lon: 11.6100 } } },
		"16": { id: 16, name: 'Obersendling', meta: { coord: { lat: 48.0970, lon: 11.5200 } } },
		"17": { id: 17, name: 'Pasing', meta: { coord: { lat: 48.1470, lon: 11.4500 } } },
		"18": { id: 18, name: 'Aubing', meta: { coord: { lat: 48.1630, lon: 11.4100 } } },
		"19": { id: 19, name: 'Moosach', meta: { coord: { lat: 48.1800, lon: 11.5200 } } },
		"20": { id: 20, name: 'Allach', meta: { coord: { lat: 48.1900, lon: 11.4700 } } },
		"21": { id: 21, name: 'Feldmoching', meta: { coord: { lat: 48.2160, lon: 11.5500 } } },
		"22": { id: 22, name: 'Eching', meta: { coord: { lat: 48.3000, lon: 11.6200 } } },
		"23": { id: 23, name: 'Ismaning', meta: { coord: { lat: 48.2300, lon: 11.6800 } } },
		"24": { id: 24, name: 'Taufkirchen', meta: { coord: { lat: 48.0500, lon: 11.6200 } } }
  },
	links: [
		// Core Munich
...
export const NETWORK_COLLATZ: NetworkData = (() => {
  ...
  const stack = [1];
  const created_numbers = new Set<number>(stack);
  let link_id = 0;

  while (stack.length > 0 && created_numbers.size <= 80) {
    const current = stack.pop()!;
    network.nodes[current] = {id: current, name: `${current}`, meta: {value: current}};
    //created_numbers.add(current);
  ...
  for (let i = 0; i < network.links.length;) {
    if (is_in(network.links[i].target, network.nodes)) i++;
    else network.links.splice(i, 1);
  }

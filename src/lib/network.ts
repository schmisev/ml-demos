...
export type Network2DNode = {node: NetworkNode, pos: {x: number, y: number}, vel: {x: number, y: number}}
...
export function network_to_graph(network: NetworkData): GraphNode[] {
  let link_id = 0;
  const nodes: GraphNode[] = network.nodes.map((v) => {return {node: v, links: [], parent: undefined, cost: 0}})
...
export const NETWORK_ROMANIA: NetworkData = {
  nodes: [
    ...
    {id: 6, name: "Mehadia", meta: {coord: {lat: 44.9000, lon: 22.3667}}},
    {id: 7, name: "Dobreta", meta: {coord: {lat: 44.6369, lon: 22.6597}}},
    {id: 8, name: "Craiova", meta: {coord: {lat: 44.3167, lon: 23.8000}}},
    {id: 9, name: "Râmnicu Vâlcea", meta: {coord: {lat: 45.1000, lon: 24.3667}}},
    ...
    {id: 13, name: "Giurgiu", meta: {coord: {lat: 43.9000, lon: 25.9667}}},
